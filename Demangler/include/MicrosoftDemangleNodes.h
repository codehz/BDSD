...
struct Node {
  ...
  virtual bool operator==(Node const &rhs) const { return kind() == rhs.kind(); }
...
struct TypeNode : public Node {
  ...
  virtual bool operator==(Node const &rhs) const override;
...
struct LocalNamedIdentifierNode : public NamedIdentifierNode {
  using NamedIdentifierNode::NamedIdentifierNode;
...
struct ThunkSignatureNode : public FunctionSignatureNode {
  ...
  struct ThisAdjustor {
    ...
    bool operator==(ThisAdjustor const &rhs) const {
      return StaticOffset == rhs.StaticOffset && VBPtrOffset == rhs.VBPtrOffset &&
             VBOffsetOffset == rhs.VBOffsetOffset && VtordispOffset == rhs.VtordispOffset;
    }
  };
...
struct NodeArrayNode : public Node {
  ...
  bool operator==(NodeArrayNode const &rhs) const;

  Node **Nodes = nullptr;
  size_t Count = 0;

  Node **begin() const { return Nodes; }
  Node **end() const { return Nodes + Count; }
};
